...
metadataFN = "/home/jms565/code/test-metadata"
...
#outFN = "/pylon1/ms4s88p/jms565/sparseGraphs/"+str(0).zfill(4)
...
outFN = "/pylon1/ms4s88p/jms565/sparseGraphs/"+str(args.subject).zfill(4)
...
#    sparseGraph2 = loadSparseGraph("/pylon1/ms4s88p/jms565/sparseGraphs/0000")
    # for i in xrange(len(superMetaData["numSubjSuperPixels"])-1):
#    for i in xrange(3):
#        fn = str(i+1).zfill(4)
        # loadedGraph = loadSparseGraph("sparseGraphs/"+fn)
#        loadedGraph = loadSparseGraph("/pylon1/ms4s88p/jms565/sparseGraphs/"+fn)
#        sparseGraph2 = sp.vstack((sparseGraph2, loadedGraph), format="csr")

#    outFN = "/pylon1/ms4s88p/jms565/sparseGraphs/compositeSparseGraph"
...
#mati = loadSparseGraph("/pylon1/ms4s88p/jms565/sparseGraphs/0000")
# check to see if min/max bot > 0
#print "  Min >= 0: " + str((mati.min())>= 0.0)
#print "  Max >= 0: " + str((mati.max())>= 0.0)
# check to see the number of elements in each col 
