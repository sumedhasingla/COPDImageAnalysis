...
class buildGraphs():
    ...
    def buildSubjectGraph(self, subj, data, neighbors=5):
        """
...
def main():
    ...
    subjGraph = Parallel(n_jobs=args.cores, backend="threading")(delayed(grapher.buildSubjectGraph)(args.subject, data, args.neighbors) for i in xrange(1))
    fn = "/pylon1/ms4s88p/jms565/test_results/"+str(args.subject).zfill(4)
    # grapher.saveSubjectGraph(subjGraph[0], fn)
